...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">了解<br />Microsoft 365 企业版</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">对于 IT 管理员：<br />启动 FastTrack for Microsoft 365</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <ul class="pivots">
            <li>
                <a href="#itadmin">IT 管理员</a>
                <ul id="itadmin">
                    <li>
                        <a data-default="true" href="#getstarted">开始使用</a>
                        <ul id="getstarted" class="cardsG">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>开始利用资源和工具，使用 Office 365、Windows 10 和企业移动性 + 安全性最大程度地获取成功。</p>
                                </div>
                            </li>
                            <li>
                                <a href="http://www.microsoft.com/microsoft-365/enterprise" target="_blank">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>为何使用 Microsoft 365 企业版？</h3>
                                                    <p>了解 Microsoft 365 企业版如何帮助组织提供广泛的应用和服务，通过统一用户、设备、应用和服务的管理来简化 IT，以及帮助保护客户数据、公司数据和知识产权。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>服务和概念</h3>
                                                    <p>了解组成 Microsoft 365 企业版的服务、需要了解的重要概念，以及安全性最佳做法和建议。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>体系结构模型和海报</h3>
                                                    <p>正在考虑采用企业云功能，并且想了解建议的功能和体系结构？ 选择并下载体系结构模型和海报 &mdash; 甚至可以修改它们以供自用。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>查找最佳做法、工具、资源以及与你的内部团队和 Microsoft 合作伙伴密切合作的专家，并有助于按照你自己的节奏完整地移动到 Microsft 365。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#it-collab">协作</a>
                        <ul id="it-collab" class="cardsG">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>查看这些指南和资源，通过帮助用户访问、编辑、管理和无缝共享其所需内容，提高用户生产力。</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Office 365 设置指南</h3>
                                                    <p>遵循本指南，确保 Office 365 企业版顺利部署。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Office 365 设置向导</h3>
                                                    <p>登录 Office 365 管理员门户，通过设置的第一步获得指导帮助。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Office 365 专业增强版部署指南</h3>
                                                    <p>Microsoft 365 企业版包括 Office 365 专业增强版包含的 Office 应用企业版。 请参阅有关规划、部署和管理 Office 365 专业增强版的指南。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>在企业中部署 Office 365 专业增强版的最佳做法</h3>
                                                    <p>了解 Office 365 产品组的建议和真实示例以及 Microsoft 服务的交付专家。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>管理员帮助：Microsoft Teams FAQ</h3>
                                                    <p>对 Microsoft Teams 管理有疑问吗？ 从这里开始。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>我的顾问</h3>
                                                    <p>利用“我的顾问”提供的实用指南 &mdash;“我的顾问”是综合性的自助服务指南和工具集，用于规划和管理 Microsoft Teams 和 Skype for Business Online。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>查找 Microsoft 认证合作伙伴</h3>
                                                    <p>如果你没有 Microsoft 帐户团队，可访问合作伙伴中心，查找所在地区的 Microsoft 认证合作伙伴。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>方便开展协作的 FastTrack</h3>
                                                    <p>获取适用于 Microsoft 365 协作功能的做法、工具、资源和专家。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#it-security">安全性</a>
                        <ul id="it-security" class="cardsG">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>Microsoft 领先的企业移动性 + 安全性 (EMS) 产品/服务与 Windows 10 企业版和 Office 365 安全功能相结合，提供身份识别与访问管理、威胁保护、信息保护和安全管理。</p>
                                    <p>请查看这些资源，获取安全性相关的建议和指南。</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>身份识别与设备访问配置</h3>
                                                    <p>了解有关如何应用策略和配置以确保员工安全高效的常规 Microsoft 建议和最佳做法。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Microsoft 针对政治宣传活动、非营利组织和其他敏捷型组织的安全指南</h3>
                                                    <p>如果你所在组织是敏捷型组织，而由你领导一个小的 IT 团队，且威胁配置文件高于平均值，那么请参阅本指南，获取指导性安全建议。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>可提高安全性的 FastTrack</h3>
                                                    <p>获取适用于 Microsoft 365 安全性功能的做法、工具、资源和专家。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#it-devices">设备</a>
                        <ul id="it-devices" class="cardsG">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>由 Microsoft 365 提供支持的设备是安装了 Windows 10 企业版和 Office 365 专业增强版，由企业移动性 + 安全性 (EMS) 管理的电脑。 该设备为用户进行了充分配置，可用于业务并具有内置安全。</p>
                                    <p>查看这些资源，充分利用由 Microsoft 365 提供支持的设备。</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows 10 部署规划</h3>
                                                    <p>检查面向 IT 专业人员的常见问题解答，了解部署注意事项、基础结构需求规划等内容。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows 即服务概述</h3>
                                                    <p>简化管理，保持用户的一致性体验。 了解通过 Windows 即服务生成、部署和维护 Windows 的新方法。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows 10 更新历史记录</h3>
                                                    <p>获取每个 Windows 10 更新中随附的改进和修复的详细信息。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用 Intune 将 Office 365 专业增强版应用分配到 Windows 10 设备</h3>
                                                    <p>了解如何在使用 Intune 将 Office 365 专业增强版应用部署到设备时配置应用套件、信息和设置。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Office 365 专业增强版的更新通道概述</h3>
                                                    <p>了解用户控制 Office 365 专业增强版新功能更新频率的选项。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用 Intune 管理软件更新</h3>
                                                    <p>了解如何在设备上配置更新设置以及延迟更新安装。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用 Configuration Manager 部署 Windows 10 更新</h3>
                                                    <p>使用 System Center Configuration Manager 进行 Windows 更新管理？ 获取有关管理 Windows 10 更新的信息。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用 Configuration Manager 管理 Office 365 ProPlus</h3>
                                                    <p>了解客户管理仪表板、部署应用和更新，以及更改更新通道等有关信息。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>适用于设备的 FastTrack</h3>
                                                    <p>获取适用于 Microsoft 365 支持的设备功能的做法、工具、资源和专家。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#it-voice">语音</a>
                        <ul id="it-voice" class="cardsG">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>Microsoft 365 中的语音功能可从几乎任何设备实时实现音频和视频协作，帮助用户提高工作效率。</p>
                                    <p>开始规划时，需要考虑各种业务场景。 从这些资源开始入手。</p>
                                </div>
                            </li>
                            <li>
                                <a href="http://aka.ms/myadvisor" target="_blank">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>我的顾问</h3>
                                                    <p>利用“我的顾问”提供的云语音实用指南 &mdash;“我的顾问”是综合性的自助服务指南和工具集，用于规划和管理 Microsoft 365 云语音。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>适用于语音的 FastTrack</h3>
                                                    <p>获取适用于 Microsoft 365 语音功能的做法、工具、资源和专家。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                <a href="#i-worker">信息工作者</a>
                <ul id="i-worker">
                    <li>
                        <a data-default="true" href="#i-worker-1">产品帮助</a>
                        <ul id="i-worker-1" class="cardsG">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>在使用 Office 365 或 Windows 10 或设备由公司管理，并且遇到了有关操作方式的问题时，可以搜索产品帮助，获取培训和提示信息，以及观看短片和教程。 </p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows 10 帮助</h3>
                                                    <p>关于 Windows 10 所有方面的帮助、操作方法和其他信息。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows 10 最终用户就绪情况</h3>
                                                    <p>用于帮助熟悉 Windows 10 在业务环境中的基本和高级功能的指南和教程。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows 10 提示</h3>
                                                    <p>正在查找如何在 Windows 10 上进行其他操作的方法？ 启动“提示”应用！</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>了解公司如何管理设备，以及当你在 Intune 中注册设备时公司看到的信息等内容。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a data-default="true" href="#i-worker-2">工作效率库</a>
                        <ul id="i-worker-2" class="cardsG">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>员工和其他用户可以从 <a href="https://www.microsoft.com/microsoft-365/success/" target="_blank">Microsoft 365 企业版工作效率库</a>获得特选培训、观看视频和阅读建议等。</p>
                                    <p>这里收录了一些有助于用户入门的链接。</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>随时随地，在几乎任何设备上更安全地工作</h3>
                                                    <p>使用 Office 365 移动应用保护业务和客户端信息。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>轻松举行会议和开展协作</h3>
                                                    <p>了解如何使用 Skype for Business 开始临时对话，进行音频或视频通话、共享和协作，以及安排在线会议。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>通过电子邮件单独工作或团体协作</h3>
                                                    <p>了解如何使用 Exchange Online 来个性化收件箱、管理电子邮件附件的版本控制，以及使用群组与人员进行协作。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>为群组选择正确的协作工具</h3>
                                                    <p>Office 365 涵盖了你的一切所需 &mdash; 可基于电子邮件进行协作的 Outlook、用于创建兴趣社区的 Yammer、用于聊天的 Microsoft Teams，或可在任何设备上举行语音和视频会议的 Skype for Business。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>共同创建有影响力的内容</h3>
                                                    <p>使用与 OneDrive 和 SharePoint 的 Office 集成，访问、共享和共同创作文档。 下载 Office 移动应用，帮助你随时随地访问所需的一切内容。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>共享网站和内容</h3>
                                                    <p>使用 SharePoint 支持在公司 Intranet 上进行共享和协作 &mdash; 创建团队网站、共享文件和协作、创建列表，并使用移动应用保持消息灵通。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>深入了解你的工作习惯</h3>
                                                    <p>通过 MyAnalytics 了解如何有效管理时间，提高生产效率，以及呈现其他团队成员正在进行的内容。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>与团队实时沟通</h3>
                                                    <p>了解如何使用 Microsoft Teams 进行查找并通过聊天与同事协作、访问集中式存储库中的内容和工具、共享信息和获取意见等更信息。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>通过了解客户的偏好来进行创建并留下深刻印象</h3>
                                                    <p>使用 Delve Boards 了解客户的感受，通过 Yammer 帖子直接获取反馈信息，通过 Power BI 可视化趋势，并使用 Sway 创建和共享报表和演示文稿。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>帮助员工筛选相关信息，更快找到答案</h3>
                                                    <p>了解如何使用 Yammer 活动报表了解组织的参与度，使用 SharePoint 提供新闻和培训等信息。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>新闻文章</h3>
                                                    <p>阅读有关 Office 365 和 Microsoft 365 的最新新闻文章。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
