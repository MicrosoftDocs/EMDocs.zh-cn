...
请按照[为本地或托管 Exchange 配置 Microsoft Intune 本地连接器](https://stage.docs.microsoft.com/en-us/intune/deployuse/intune-on-premises-exchange-connector)中的步骤下载、安装和配置 Microsoft Intune Exchange Connector。
...
请按照[配置条件访问策略](https://stage.docs.microsoft.com/en-us/intune/deployuse/restrict-access-to-exchange-onpremises-with-microsoft-intune#-a-name-bkmk_enablexchngonprem-a-configure-a-conditional-access-policy)下提供的信息设置你的条件访问策略。
