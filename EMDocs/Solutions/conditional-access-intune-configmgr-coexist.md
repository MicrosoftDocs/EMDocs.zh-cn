...
## 部署步骤
要部署并存解决方案，请按照上述步骤部署[本地 Exchange Server](../Solutions/conditional-access-intune-configmgr-exchange.md) 和 [Exchange Online](../Solutions/conditional-access-intune-configmgr-exchange-online.md) 解决方案。
