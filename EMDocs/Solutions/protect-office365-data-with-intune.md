---
title: "使用 Microsoft Intune 保护 Office 365 公司数据 | Microsoft Intune"
description: 
keywords: 
author: jeffgilb
manager: angrobe
...
> <sup>仅 1</sup>仅 iOS 和 Android <sup>2</sup> iOS、Android 和 Windows 设备

### 安全访问 Exchange Online
...
### 用于托管的 Windows 10 电脑和移动设备的 Windows 信息保护 (WIP)
...
### 了解详细信息
[托管移动生产力方案](https://docs.microsoft.com/enterprise-mobility/solutions/managed-mobile-productivity)

[Microsoft 企业移动性](https://www.microsoft.com/cloud-platform/enterprise-mobility)
