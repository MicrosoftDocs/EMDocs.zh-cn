...
<article id="main">
    <section id="hero-content" class="graph">
        ...
        <h2>Microsoft&#39;s 企业移动性服务使组织能够在确保企业数据受保护的同时保持员工跨应用和设备的工作效率</h2>
        <!-- <ol id="actions" class="action-list">
        <li><a href="" class="button button-bordered">Learn More</a></li>
        </ol> -->
        <h3>对企业移动性还不熟悉？ <a href="https://www.microsoft.com/server-cloud/enterprise-mobility/overview.aspx" target="_blank">访问企业移动性页面 &rarr;</a></h3>
    </section>
